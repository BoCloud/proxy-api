	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProxyV1beta1().TCPRoutes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProxyV1beta1().TCPRoutes(namespace).Watch(context.TODO(), options)
			},
		},
		&proxyv1beta1.TCPRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tCPRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&proxyv1beta1.TCPRoute{}, f.defaultInformer)
}

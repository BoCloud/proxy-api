...
import (
	...
	v1beta1 "github.com/bocloud/proxy-api/generated/proxy/listers/proxy/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProxyV1beta1().UDPRoutes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProxyV1beta1().UDPRoutes(namespace).Watch(context.TODO(), options)
			},
		},
		&proxyv1beta1.UDPRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *uDPRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&proxyv1beta1.UDPRoute{}, f.defaultInformer)
}

func (f *uDPRouteInformer) Lister() v1beta1.UDPRouteLister {
	return v1beta1.NewUDPRouteLister(f.Informer().GetIndexer())
}

...
type FakeHTTPRoutes struct {
	Fake *FakeProxyV1beta1
	ns   string
}

var httproutesResource = schema.GroupVersionResource{Group: "proxy.bocloud.io", Version: "v1beta1", Resource: "httproutes"}

var httproutesKind = schema.GroupVersionKind{Group: "proxy.bocloud.io", Version: "v1beta1", Kind: "HTTPRoute"}
